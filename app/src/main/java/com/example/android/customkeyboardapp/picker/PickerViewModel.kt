...
import com.example.android.customkeyboardapp.util.SingleLiveEvent
    ...
    fun setPhotos(cursor: Cursor?) {
        cursor?.let { c ->
            ...
            array.add(
                0, SelectableImage(
                    0,
                    Uri.parse("android.resource://com.example.android.customkeyboardapp/drawable/ic_gallery_icon"),
                    false
                )
            )
