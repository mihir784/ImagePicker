...
import com.example.android.customkeyboardapp.ext.isPermissionGranted
import com.example.android.customkeyboardapp.ext.parentAs
import com.example.android.customkeyboardapp.util.CameraActivity
import com.example.android.customkeyboardapp.util.NonDismissibleBehavior
import com.example.android.customkeyboardapp.util.SpacingItemDecoration
...
class PhotoPickerFragment : DialogFragment() {
    ...
    companion object {
        ...
        fun newInstance(
            ...
            @StyleRes theme: Int = R.style.CustomLight
